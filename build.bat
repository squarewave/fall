...
set GameExports=-EXPORT:game_update_and_render -EXPORT:game_imgui_get_io -EXPORT:game_imgui_new_frame -EXPORT:game_imgui_shutdown -EXPORT:game_imgui_render -EXPORT:game_imgui_get_tex_data_as_rgba32
...
cl %CommonCompilerFlags% -LD ..\fall.cpp -Fmfall.map /link -incremental:no -opt:ref -PDB:fall_%random%.pdb %GameExports% -libpath:"..\libs\bin" Judy.lib
del lock.tmp
