#ifndef IMGUI_MEMORY_EDITOR_H__
#define IMGUI_MEMORY_EDITOR_H__
                ...
                for (int n = 0; n < Rows && addr < mem_size; n++, addr++)
                {
                    ...
                    if (DataEditingAddr == addr)
                    {
                        ...
                        if (DataEditingTakeFocus)
                        {
                            ...
                            sprintf(AddrInput, "%0*llX", addr_digits_count, base_display_addr+addr);
...
#endif /* end of include guard: IMGUI_MEMORY_EDITOR_H__ */
